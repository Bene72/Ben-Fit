...
import { NOTE_COLORS, S, font, bebas } from '../../lib/coachDashboard/offersAndCompliance'
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {(notes || []).map((note) => {
            ...
            return (
              ...
              >
                <div style={{ fontSize: 13, color: '#2B2A28', lineHeight: 1.5, paddingRight: 24 }}>
                  {note.text}
                </div>
                <div style={{ fontSize: 10, color: 'rgba(0,0,0,0.5)', marginTop: 6 }}>
                  📅 {note.createdAt}
                </div>
                <button
