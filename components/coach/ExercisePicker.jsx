      ...
      <div style={{ background: 'white', borderRadius: '16px', padding: '24px', width: '420px', maxWidth: '95vw', boxShadow: '0 20px 60px rgba(0,0,0,0.3)', maxHeight: '80vh', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', marginBottom: '14px' }}>
          <button 
            ...
            style={{ 
              flex: 1, padding: '8px', 
              background: mode === 'search' ? '#0D1B4E' : '#EEF2FF', 
              color: mode === 'search' ? 'white' : '#0D1B4E', 
          ...
          <button 
            ...
            style={{ 
              flex: 1, padding: '8px', 
              background: mode === 'free' ? '#4A6FD4' : '#EEF2FF', 
              color: mode === 'free' ? 'white' : '#4A6FD4', 
              border: 'none', borderRadius: '8px', 
              fontWeight: '600', fontSize: '13px', 
              cursor: 'pointer', fontFamily: "'DM Sans',sans-serif" 
            }}
        ...
        {mode === 'free' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <input
              ...
              onKeyDown={e => { if (e.key === 'Enter' && freeText.trim()) onConfirm(freeText.trim(), null) }}
            />
            <button
              ...
              style={{ 
                padding: '10px', 
                background: freeText.trim() ? '#4A6FD4' : '#CCC', 
                color: 'white', 
                border: 'none', 
                borderRadius: '8px', 
                fontSize: '14px', 
        ...
        <button 
          ...
          style={{ 
            ...
            border: '1px solid #C5D0F0', borderRadius: '8px', 
