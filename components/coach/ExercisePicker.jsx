  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: 12, color: 'var(--chalk-dim)', marginBottom: 14 }}>
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 14 }}>
          <button
            ...
            style={{
              flex: 1,
              padding: 8,
              background: mode === 'search' ? 'var(--accent)' : 'var(--accent-dim)',
              color: mode === 'search' ? '#fff' : 'var(--chalk)',
              border: 'none',
              borderRadius: 8,
              fontWeight: 600,
              fontSize: 13,
          ...
          <button
            ...
            style={{
              flex: 1,
              padding: 8,
              background: mode === 'free' ? 'var(--accent)' : 'var(--accent-dim)',
              ...
              {!loading &&
                ...
                filtered.map((f) => (
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 500, fontSize: 14, color: 'var(--chalk)' }}>
                      {f.name}
                    </span>
                  </div>
                ))}
        ...
        {mode === 'free' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <button
              ...
              style={{
                padding: 10,
                background: freeText.trim() ? 'var(--accent)' : 'var(--bg-card-2)',
                color: freeText.trim() ? '#fff' : 'var(--chalk-muted)',
                border: 'none',
                borderRadius: 8,
                fontSize: 14,
                fontWeight: 600,
        ...
        <button
          ...
          style={{
            marginTop: 12,
            padding: 10,
            background: addedNames.length > 0 ? 'var(--accent)' : 'transparent',
            color: addedNames.length > 0 ? '#fff' : 'var(--chalk-dim)',
            border: addedNames.length > 0 ? 'none' : '1px solid var(--border-hi)',
            borderRadius: 8,
            fontSize: 13,
            fontWeight: 700,
            cursor: 'pointer',
