...
import { S, font, bebas, mono } from '../../lib/coachDashboard/offersAndCompliance'
        ...
        <>
          ...
          {subTab === 'list' ? (
            ...
            >
              {sorted.map((e, i) => (
                <div
                  key={e.id || e.date}
                  style={{
                    background: i === 0 ? 'var(--bg-card-2)' : 'var(--bg-input)',
                    borderRadius: 11,
                    padding: '10px 13px',
            ...
            <div>
                ...
                {availableFields.map((f) => (
                  <button
                    ...
                    style={{
                      ...
                      fontSize: 12,
                      fontWeight: 700,
                      background: field === f.key ? f.color : 'var(--bg-card-2)',
              ...
              <div style={{ background: 'var(--bg-card-2)', borderRadius: 12, padding: '16px 14px' }}>
