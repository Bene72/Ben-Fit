  ...
  return (
    ...
    >
      ...
      >
        ...
        <button onClick={() => setShowForm(!showForm)} style={btn('var(--accent)', 'white')}>
      ...
      {showForm && (
        ...
        >
          ...
          <button
            onClick={addMeasure}
            disabled={saving}
            style={btn(saving ? 'var(--bg-card-2)' : 'var(--success)', saving ? 'var(--chalk-muted)' : 'white')}
          >
            {saving ? '...' : '✓ Enregistrer'}
          </button>
        </div>
            ...
            >
              {editingId === m.id ? (
                <>
                  ...
                  <div style={{ display: 'flex', gap: '6px' }}>
                    ...
                    <button
                      ...
                      style={btn('transparent', 'var(--chalk-dim)', 'var(--border)', '12px')}
                    >
                      ✕
                    </button>
                  </div>
                ...
                <>
                  ...
                  <span style={{ fontWeight: '700', color: 'var(--chalk)' }}>{m.weight} kg</span>
                  <div style={{ display: 'flex', gap: '6px' }}>
                    <button
                      onClick={() => startEdit(m)}
                      style={btn('transparent', 'var(--chalk)', 'var(--border)', '12px')}
                    >
                      ✏️
                    </button>
                    <button
