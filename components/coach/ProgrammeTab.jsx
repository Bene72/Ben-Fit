          ...
          >
            ...
            >
              <div>
                ...
                <select
                  value={wbForm.type}
                  onChange={(e) => setWbForm((p) => ({ ...p, type: e.target.value }))}
                  style={inp}
                >
                  {['For Time', 'AMRAP', 'EMOM', 'Tabata', 'RFT', 'Death By'].map((t) => (
                    <option key={t}>{t}</option>
                  ))}
                </select>
              </div>
              <div>
                ...
                <input
                  value={wbForm.rounds}
                  onChange={(e) => setWbForm((p) => ({ ...p, rounds: e.target.value }))}
                  style={inp}
                />
              </div>
              <div>
                ...
                <input
                  value={wbForm.cap}
                  onChange={(e) => setWbForm((p) => ({ ...p, cap: e.target.value }))}
                  placeholder="ex: 20"
                  style={inp}
                />
              </div>
              <div>
                ...
                <input
                  value={wbForm.rest}
                  onChange={(e) => setWbForm((p) => ({ ...p, rest: e.target.value }))}
                  style={inp}
                />
              </div>
            </div>
            <div style={{ marginBottom: 10 }}>
              ...
              <input
                value={wbForm.objective}
                onChange={(e) => setWbForm((p) => ({ ...p, objective: e.target.value }))}
            ...
            <div style={{ marginBottom: 10 }}>
              ...
              <input
                value={wbForm.coachNote}
                onChange={(e) => setWbForm((p) => ({ ...p, coachNote: e.target.value }))}
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <textarea
                value={wbForm.movements}
                onChange={(e) => setWbForm((p) => ({ ...p, movements: e.target.value }))}
                placeholder={
                  '21 Thrusters 43kg\n21 Pull-ups\n15 Thrusters\n15 Pull-ups\n9 Thrusters\n9 Pull-ups'
                }
                rows={6}
          ...
          >
            ...
            >
              <input
                ...
                onChange={(e) => setResetWeights(e.target.checked)}
              />
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              <button
                onClick={() => duplicateProgram(duplicateTarget)}
                disabled={!duplicateTarget || duplicating}
                style={btnVariant('primary')}
              >
                {duplicating ? '⏳ Duplication…' : '📋 Dupliquer'}
              </button>
              <button onClick={() => setShowDuplicate(false)} style={btnVariant('ghost')}>
                Annuler
              </button>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            >
              <h3 style={{ margin: 0, color: 'var(--navy)' }}>
                {openArchivedCycle ? (
                  <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <button
                      onClick={() => setOpenArchivedCycle(null)}
              ...
              <button onClick={() => setShowHistory(false)} style={btnVariant('ghost')}>
                ✕ Fermer
              </button>
            </div>
            ...
            {archivedCycles.length === 0 ? (
              ...
              archivedCycles.map((cycle) => (
                <button
                  key={cycle.key}
                  onClick={() => setOpenArchivedCycle(cycle.key)}
                  style={{
                    width: '100%',
                    textAlign: 'left',
                    marginBottom: 10,
              ...
              archivedCycles
                .find((c) => c.key === openArchivedCycle)
                ?.workouts.slice()
