        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'flex-start', marginBottom: '10px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '3px', flexShrink: 0, paddingTop: '6px' }}>
            <button 
              ...
              disabled={isFirst}
              style={{ 
                width: '26px', height: '24px', border: '1px solid #C5D0F0', borderRadius: '5px', 
                background: isFirst ? '#F5F5F5' : 'white', color: isFirst ? '#CCC' : '#0D1B4E', 
                cursor: isFirst ? 'default' : 'pointer', fontSize: '10px', 
            ...
            <button 
              ...
              style={{ 
                width: '26px', height: '24px', border: '1px solid #C5D0F0', borderRadius: '5px', 
                background: isLast ? '#F5F5F5' : 'white', color: isLast ? '#CCC' : '#0D1B4E', 
                cursor: isLast ? 'default' : 'pointer', fontSize: '10px', 
                display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 0 
              }}
            >▼</button>
          </div>
          ...
          <button 
            ...
            style={{ 
              ...
              background: 'rgba(196,92,58,0.12)', color: '#C45C3A', cursor: 'pointer', 
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '8px', marginBottom: '10px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
            ...
            <input 
              type="number" 
              value={ex.sets} 
              onChange={e => onUpdate(wId, ex.id, 'sets', e.target.value)}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
            ...
            <input 
              value={ex.reps} 
              onChange={e => onUpdate(wId, ex.id, 'reps', e.target.value)}
              style={{ ...ci, textAlign: 'center', fontSize: '14px', fontWeight: '700', padding: '8px 4px' }} 
            />
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
            ...
            <input 
              ...
              placeholder="80kg" 
              style={{ ...ci, textAlign: 'center', fontSize: '13px', padding: '8px 4px' }} 
            />
          </div>
        </div>
          ...
          <div>
            ...
            {recentLog && (
              <button 
                ...
                style={{ marginTop: '3px', border: 'none', background: 'none', padding: 0, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px' }}
              >
                ...
                <span style={{ fontSize: '9px', color: '#9BA8C0' }}>
