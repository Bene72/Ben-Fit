...
// ── Navigation items ─────────────────────────────────────────
// Pour réactiver Messages : décommenter la dernière ligne du tableau
const NAV_ITEMS = [
  ...
  // { href: '/messages', label: 'Messages', icon: '💬' },  ← DÉSACTIVÉ temporairement
]
    ...
    <>
      ...
      <aside style={{
        ...
        <div style={{ flex: 1, padding: '14px 12px', overflowY: 'auto' }}>
          ...
          {/* Messages — visible desktop, grisé, non cliquable */}
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '11px 12px', borderRadius: '10px', opacity: 0.28, marginBottom: '4px' }}>
            <div style={{ width: '22px', textAlign: 'center', fontSize: '14px' }}>💬</div>
            <div style={{ fontSize: '13px', color: 'white', fontWeight: '500' }}>Messages</div>
            <span style={{ marginLeft: 'auto', fontSize: '9px', color: 'rgba(255,255,255,0.5)', whiteSpace: 'nowrap' }}>bientôt</span>
          </div>
        </div>
