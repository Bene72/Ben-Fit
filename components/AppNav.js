...
export default function AppNav({ profile }) {
  ...
  const showMobileBrandBar = pathname !== '/messages'
          ...
          <>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', minWidth: 0 }}>
                <img src="/logo-small.png" alt="Ben&Fit" style={{ width: '30px', height: '30px', objectFit: 'contain' }} />
                <div style={{ minWidth: 0 }}>
                  <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: '18px', color: 'white', letterSpacing: '1.5px', lineHeight: 1 }}>
                    BEN&FIT
                  </div>
                  <div style={{ fontSize: '8px', color: 'rgba(255,255,255,0.45)', letterSpacing: '1px', textTransform: 'uppercase', marginTop: '2px' }}>
