    ...
    return (
      <div className="tp-wblock" style={{ border: `2px solid ${tc}` }}>
        <div className="tp-wblock-head" style={{ background: tc }}>
          ...
          <div className="label">{meta.type || 'Workout Block'}</div>
          <div className="tp-wblock-headright">
            {meta.rounds && meta.rounds > 1 && <div className="rounds">{meta.rounds} rounds</div>}
            {meta.cap && <CapBadge minutes={meta.cap} />}
          </div>
        </div>
...
function CapBadge({ minutes }) {
  return (
    <div className="tp-cap-badge" title="Temps limite (CAP)">
