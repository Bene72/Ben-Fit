...
export default function ElevesPage() {
  ...
  const loadClients = async (coachId) => {
    try {
      ...
      // de la lecture à des clients d'un autre coach (voir pages/coach.js,
      // même correctif déjà appliqué là-bas — pages/eleves.js dupliquait la
      // même fonctionnalité sans avoir reçu le correctif, cf. audit du 10/07/2026).
  ...
  const createClient = async () => {
    ...
    if (form.password.length < 10) {
      setCreateError('Le mot de passe doit faire au moins 10 caractères.')
      return
    }
                ...
                >
                  <div
                    style={{
                      ...
                      alignItems: 'center',
                      gap: 14,
                      marginBottom: client.current_program || client.objective ? 14 : 0,
                    }}
                  >
                    <div
                      style={{
