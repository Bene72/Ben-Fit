 ...
 *   (AUDIT 09/09/2026 : cette route n'était protégée que par withAuth() simple,
 *   sans requireCoach. Elle n'est appelée par aucun composant frontend pour
 *   l'instant, mais restait exploitable par n'importe quel client authentifié
 *   pour déclencher des appels Anthropic payants. Verrouillée en requireCoach.
 *   Si cette route n'est finalement jamais utilisée, la supprimer purement et
 *   simplement plutôt que de la laisser comme surface d'attaque morte.)
...
async function handler(req, res) {
  ...
  if (
    await checkRateLimit(req, res, { maxRequests: 5, windowMs: 60_000, routeKey: 'generate-cycle' })
  )
    return
