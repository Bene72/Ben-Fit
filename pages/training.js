              ...
              <div style={{ padding: '20px 24px' }}>
                ...
                {isEdit && (
                  <div style={{ display: 'flex', gap: '8px', marginTop: '16px', flexWrap: 'wrap' }}>
                    ...
                    <button onClick={() => addExercise(workout.id, 'Superset', null)} style={btnStyle('#C45C3A', 'white')}>⚡ Superset</button>
                    <button onClick={() => addExercise(workout.id, 'Giant Set', null)} style={btnStyle('#8FA07A', 'white')}>🔥 Giant Set</button>
