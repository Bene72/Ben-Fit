...
export default function TrainingPage() {
  ...
  function ExerciseInlineDetails({ exercise }) {
    ...
    return (
      ...
      >
        <div className="ui-grid-2" style={{ gridTemplateColumns: 'minmax(0, 1.2fr) minmax(320px, 0.8fr)' }}>
  ...
  return (
    ...
    >
      ...
      <div className="ui-grid-2" style={{ gridTemplateColumns: '300px minmax(0, 1fr)' }}>
        <div className="ui-stack">
