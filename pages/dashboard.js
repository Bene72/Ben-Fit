  ...
  return (
    <>
      ...
      <Layout title={isMobile ? "" : "Dashboard"} user={user}>
        ...
        {/* ─── ONGLETS ─── */}
        <div style={{ display: 'flex', gap: '4px', marginBottom: isMobile ? '16px' : '24px', borderBottom: '2px solid #E8ECFA', paddingBottom: '0', overflowX: 'auto' }}>
          {[
            { id: 'dashboard', label: isMobile ? '📊 Accueil' : '📊 Tableau de bord' },
            { id: 'body',      label: isMobile ? '📏 Corps' : '📏 Mensurations' },
            { id: 'recipe',    label: isMobile ? '🍽️ Recette' : '🍽️ Recette de la semaine' },
          ].map(tab => (
            <button
              key={tab.id}
              onClick={() => setActiveTab(tab.id)}
              style={{
                padding: isMobile ? '8px 12px' : '10px 18px', border: 'none', borderRadius: '10px 10px 0 0',
                fontSize: isMobile ? '12px' : '13px', fontWeight: '700', whiteSpace: 'nowrap',
        ...
        <div style={{ background: 'linear-gradient(135deg, #0D1B4E, #3A4230)', borderRadius: '14px', padding: isMobile ? '16px 18px' : '22px 28px', color: 'white', display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'flex-start' : 'center', justifyContent: 'space-between', gap: '12px', marginBottom: isMobile ? '16px' : '24px' }}>
          <div>
            <div style={{ fontFamily: "'Playfair Display',serif", fontSize: isMobile ? '20px' : '18px', marginBottom: '4px' }}>Bonjour {profile?.full_name?.split(' ')[0] || 'Toi'} 👋</div>
            <div style={{ fontSize: '12px', opacity: 0.75 }}>{today} · {profile?.current_program || 'Aucun programme'}</div>
          </div>
          <div style={{ display: 'flex', gap: '8px', width: isMobile ? '100%' : 'auto' }}>
            <button onClick={() => router.push('/training')} style={{ flex: isMobile ? 1 : 'none', padding: '10px 16px', background: '#4A6FD4', color: 'white', border: 'none', borderRadius: '8px', fontSize: '13px', fontWeight: '700', cursor: 'pointer', fontFamily: "'DM Sans',sans-serif" }}>▶ Séance du jour</button>
            <button onClick={() => router.push('/messages')} style={{ flex: isMobile ? 1 : 'none', padding: '10px 16px', background: 'rgba(255,255,255,0.15)', color: 'white', border: '1px solid rgba(255,255,255,0.2)', borderRadius: '8px', fontSize: '13px', fontWeight: '700', cursor: 'pointer', fontFamily: "'DM Sans',sans-serif" }}>💬 Coach</button>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3,1fr)', gap: isMobile ? '10px' : '16px', marginBottom: isMobile ? '16px' : '24px' }}>
          <div style={{ background: '#F0F4FF', border: '1px solid #C5D0F0', borderRadius: '14px', padding: isMobile ? '14px 16px' : '20px 24px', borderTop: '3px solid #4A6FD4' }}>
          ...
          <div style={{ background: '#F0F4FF', border: '1px solid #C5D0F0', borderRadius: '14px', padding: isMobile ? '14px 16px' : '20px 24px', borderTop: '3px solid #C45C3A' }}>
          ...
          <div style={{ background: '#F0F4FF', border: '1px solid #C5D0F0', borderRadius: '14px', padding: isMobile ? '14px 16px' : '20px 24px', borderTop: '3px solid #0D1B4E' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? '10px' : '16px', marginBottom: isMobile ? '16px' : '24px' }}>
        ...
        {profile?.coach_note && (
           <div style={{ background: '#F0F4FF', border: '1px solid #C5D0F0', borderRadius: '14px', padding: isMobile ? '14px 16px' : '20px 24px', marginBottom: '16px' }}>
