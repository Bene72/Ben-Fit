            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  borderBottom:
                    activeTab === tab.id ? '2px solid var(--navy)' : '2px solid transparent',
                  marginBottom: -1,
              ...
              >
                ...
                >
                  <div>
                    ...
                    <div
                      style={{ fontSize: 14, color: 'rgba(255,255,255,0.55)', marginBottom: 20 }}
                    >
              ...
              >
                  ...
                  >
                    <div
                      style={{
                        ...
                        width: `${Math.min(100, (sessions.length / 5) * 100)}%`,
                        borderRadius: 99,
                      }}
                    />
                  </div>
                  <div
                    style={{ marginTop: 6, fontSize: 11, color: 'var(--success)', fontWeight: 700 }}
                  >
                    {adherence}% adherence
                  </div>
                </div>
                ...
                >
                  ...
                  {weightDelta && (
                    ...
                    >
                      {parseFloat(weightDelta) > 0 ? '▲' : '▼'} {Math.abs(weightDelta)} kg vs
                      dernière mesure
                    </div>
                  )}
                </div>
                ...
                >
                  ...
                  {measures.length === 0 ? (
                    <div style={{ color: 'var(--text-faint)', fontSize: 13 }}>
                      Aucune mesure. Clique pour en ajouter !
                    </div>
                  ) : (
                      ...
                      {measures.slice(0, 3).map((m, i) => (
                        ...
                        >
                          ...
                          <span style={{ fontSize: 11, color: 'var(--text-faint)' }}>
                            {[m.waist && `T:${m.waist}`, m.hips && `H:${m.hips}`]
                              .filter(Boolean)
                              .join(' ')}
                          </span>
                          {i === 0 && (
