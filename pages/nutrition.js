...
export default function NutritionPage() {
  ...
  if (loading) {
    return (
      <AppShell title={isMobile ? '' : 'Nutrition'} subtitle="Chargement de ta nutrition...">
      {isMobile ? (
        <div style={ marginTop: '-6px', marginBottom: 16 }>
          ...
          <div style={ fontWeight: 900, fontSize: 22, color: '#0D1B4E', marginBottom: 6 }>Nutrition</div>
          <div className='ui-muted' style={ marginBottom: 6 }>Un tableau de bord plus clair pour suivre tes apports et comparer facilement avec le plan.</div>
        </div>
      ) : null}
        <SurfaceCard padded>
  ...
  return (
    <AppShell title={isMobile ? '' : 'Nutrition'}
      subtitle={isMobile ? '' : 'Un tableau de bord plus clair pour suivre tes apports et comparer facilement avec le plan.'}
