...
import { NutritionRingsRow, NutritionScoreBlock, NutritionWeekGraph } from '../components/nutrition/NutritionVisuals'
          ...
          {activeTab === 'today' ? (
            <>
              ...
              <SurfaceCard padded>
                ...
                <NutritionRingsRow
                  log={{
                    calories: combinedValues.calories,
                    protein: combinedValues.protein,
                    carbs: combinedValues.carbs,
                    fat: combinedValues.fat,
                  }}
                  plan={plan}
                />
              ...
              {/* Score du jour + graphe 7 jours — mêmes visuels que la vue coach */}
              <NutritionScoreBlock
                log={{
                  calories: combinedValues.calories,
                  protein: combinedValues.protein,
                ...
                plan={plan}
              />
              <NutritionWeekGraph logs={logs} plan={plan} today={todayString()} />
