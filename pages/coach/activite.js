...
const EVENT_META = {
  measure: { icon: '⚖️', color: 'var(--danger)', bg: '#FFF3EE', verb: 'a enregistré une mesure' },
  session: {
    icon: '💪',
    color: 'var(--success)',
    bg: 'var(--success-bg)',
  ...
  bilan: { icon: '📋', color: 'var(--gold)', bg: '#FFFBEE', verb: 'a soumis un bilan' },
}
        ...
        <div style={{ display: 'flex', gap: 8, marginBottom: 20, flexWrap: 'wrap' }}>
          {[
            ...
            >
              ...
              <span
                style={{
                  background: filter === f.id ? 'rgba(255,255,255,0.2)' : 'var(--border-soft)',
