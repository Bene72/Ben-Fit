            ...
            {isOpen && (
              <div style={{ padding: '16px 20px' }}>
                ...
                {workout.exercises?.length > 0 && (
                  <div style={{ display: 'grid', gridTemplateColumns: isEdit ? '24px 1fr 70px 80px 100px 100px 2fr 28px' : '1fr 60px 70px 80px 90px 1fr', gap: '8px', padding: '8px 14px', marginBottom: '4px' }}>
...
function ExRow({ ex, wId, edit, onUpdate, onDelete, onMove, isFirst, isLast }) {
  ...
  return (
    ...
    <div style={{ display: 'grid', gridTemplateColumns: edit ? '24px 1fr 70px 80px 100px 100px 2fr 28px' : '1fr 60px 70px 80px 90px 1fr', gap: '8px', alignItems: 'center', padding: '12px 14px', borderBottom: '1px solid rgba(0,0,0,0.06)' }}>
      {edit && (
