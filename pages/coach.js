...
function CoachHub({ clients, user, sessionsThisWeek, lastWeight, unreadCounts, onSelectClient, onNewClient }) {
  ...
  // ── Activité récente (dernières mesures triées)
  ...
  return (
    <div style={{ padding: '28px 32px', maxWidth: 1400 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: 20 }}>
        ...
        {/* ── CLIENTS CARDS ── */}
        <div>
          <div style={{ fontSize: 11, letterSpacing: '2px', textTransform: 'uppercase', color: '#6B7A99', fontWeight: 700, marginBottom: 14 }}>
            Tous les clients
          </div>
  ...
  if (edit) {
    return (
      <div style={{ background: '#FAFBFF', border: '1.5px solid #C5D0F0', borderRadius: '12px', padding: '14px 14px 12px', marginBottom: '10px' }}>
        {/* Ligne 1 : flèches + nom exercice + supprimer */}
        ...
        {/* Ligne 2 : Séries · Reps · Repos · Charge (compacts en ligne) */}
