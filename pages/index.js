...
export default function Login() {
  ...
  useEffect(() => {
    ...
    check()
    // eslint-disable-next-line react-hooks/exhaustive-deps -- exécution unique au montage (vérif session)
  }, [])
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              'radial-gradient(ellipse at 30% 50%, rgba(255,255,255,0.04) 0%, transparent 60%), radial-gradient(ellipse at 70% 20%, rgba(255,255,255,0.03) 0%, transparent 50%)',
            pointerEvents: 'none',
          }}
        />
        <div
          style={{
            ...
            right: 0,
            height: '300px',
            background: 'linear-gradient(to top, rgba(6,12,38,0.8), transparent)',
            pointerEvents: 'none',
          }}
        />
            ...
            {view === 'forgot' && (
              <>
                ...
                <div style={{ textAlign: 'center', marginBottom: '28px' }}>
                  ...
                  <div
                    style={{ fontSize: '12px', color: 'rgba(255,255,255,0.4)', marginTop: '8px' }}
                  >
                ...
                {forgotSent ? (
                  <div
                    style={{
                      background: 'rgba(74,111,212,0.2)',
                      border: '1px solid rgba(74,111,212,0.4)',
                      borderRadius: '10px',
                      padding: '16px',
                      textAlign: 'center',
                      color: 'white',
                  ...
                  <>
                    ...
                    <button
                      ...
                      style={{
                        width: '100%',
                        padding: '14px',
                        background: forgotLoading ? 'rgba(255,255,255,0.1)' : 'white',
                        color: forgotLoading ? 'rgba(255,255,255,0.4)' : 'var(--navy)',
                        border: 'none',
                        borderRadius: '10px',
                        fontSize: '14px',
                        fontWeight: '700',
